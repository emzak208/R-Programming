...
# Problem 1 :
# add zero to the first position in a vector, remove the last element
x<- c(1,2,3,4,5)
for( i in length(x):2)
  {
  x[i]= x[i-1]
...
# problem 3:
# how to see if a point is inside a triangle
...
####    or, in hexadecimal, with trailing zeros not printed
sprintf("%a",a)
...
####    we have 64 bits for a double, we can store at most 2^64 numbers
